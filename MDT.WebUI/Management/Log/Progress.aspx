<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Progress.aspx.cs" Inherits="MDT.WebUI.Management.Configuration.Task.Progress" %>
...
<body style="padding:0px; margin:0px; background-color:transparent;">
        <form id="Form1" method="post" runat="server" style="padding:0px; margin:0px;">
            ...
            <asp:Label ID="lblWait" runat="server" Text="正在重发数据，请稍后...."></asp:Label>
