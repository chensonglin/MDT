...
EAL.prototype = {
    ...
    delete_instance: function (id) {
        ...
        if (iframe) {
            ...
            try { delete fs["frame_" + id]; } catch (e) { }
        }
        delete eAs[id];
    },
    start: function (id) {
        ...
        if (!eAs[id]["initialized"]) {
            ...
            if (eAs[id]["settings"]["display"] == "later") {
                eAs[id]["initialized"] = true; return;
            }
        }
        if (t.isIE) {
        ...
        father = area.textarea.parentNode; content = d.createElement("iframe");
    ...
    toggle_off: function (id) {
        ...
        if (fs["frame_" + id]) {
            ...
            parNod = t.parentNode; nxtSib = t.nextSibling;
    ...
    toggle_on: function (id) {
        ...
        if (fs["frame_" + id]) {
            f = fs["frame_" + id];
            t = eAs[id]["textarea"];
            area = f.editArea; area.textarea.value = t.value;
            ...
            elem.use_last = true; eAL.start(id);
        }
    },
    ...
    submit: function (e) {
        ...
        formObj = eAL.isIE ? window.event.srcElement : e.target;
        if (formObj.tagName != 'FORM') formObj = formObj.form; for (i in eAs) {
            is_child = false; for (x = 0; x < formObj.elements.length; x++) {
                if (formObj.elements[x].id == i) is_child = true;
            }
            if (is_child) {
    ...
    getSelectionRange: function (id) {
        ...
        if (fs["frame_" + id] && eAs[id]["displayed"] == true) {
            eA = fs["frame_" + id].editArea; sel["start"] = eA.textarea.selectionStart;
...
function getMouseX(e) {
    if (e != null && typeof (e.pageX) != "undefined") { return e.pageX; }
    else {
...
function getMouseY(e) {
    if (e != null && typeof (e.pageY) != "undefined") { return e.pageY; }
        ...
        try {
            ...
            if (stored_range.parentElement() == t) {
                ...
                while (elem.parentNode) {
                    scrollTop += elem.scrollTop; elem = elem.parentNode;
                }
